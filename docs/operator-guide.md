...
1. Define the operator's tannery coverage and crew intake process.
2. Define consent and purpose categories for tanner/facility records.
...
- provenance for all operating records (tanner and facility both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  tanning-execution decision, a chemical-safety-clearance decision, or
...
tanning-execution decision, a chemical-safety-clearance decision, or a
